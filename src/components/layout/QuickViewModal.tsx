...
import { X, Star, ShoppingBag, Heart, Minus, Plus, ChevronLeft, ChevronRight } from 'lucide-react';
              ...
              <div className="mb-6">
                <div className="flex flex-col sm:flex-row sm:items-end gap-3">
                  ...
                  <button
                    ...
                    className={`w-full sm:flex-1 flex items-center justify-center gap-2 h-11 sm:h-10 rounded-xl font-bold text-sm transition-all duration-200 ${
                      effectiveSelectedSize
                        ? 'bg-black text-white hover:bg-[#FF7348] hover:scale-[1.01] shadow-lg'
