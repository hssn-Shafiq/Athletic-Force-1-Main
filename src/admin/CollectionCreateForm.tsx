        ...
        <div className="inline-flex rounded-2xl border border-slate-200 bg-white p-1">
          <button
            ...
            className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-black uppercase tracking-wider transition-colors ${
              viewMode === 'create' ? 'bg-black text-white' : 'text-slate-500 hover:text-black'
            }`}
          >
          ...
          <button
            ...
            className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-black uppercase tracking-wider transition-colors ${
              viewMode === 'list' ? 'bg-black text-white' : 'text-slate-500 hover:text-black'
            }`}
          >
          ...
          <section className="lg:col-span-2 bg-white rounded-[32px] border border-slate-100 shadow-sm p-6 md:p-8 space-y-6">
            ...
            <div className="flex items-center justify-end gap-3">
              ...
              <button
                ...
                className="px-6 py-3 rounded-2xl bg-[#FF7348] text-white text-xs font-black uppercase tracking-wider hover:bg-orange-500 disabled:opacity-60 disabled:cursor-not-allowed"
              >
