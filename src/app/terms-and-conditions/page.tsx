...
import { Gavel, CheckCircle2, AlertCircle, FileStack, ChevronRight } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-[#FF5A2A] rounded-[40px] p-10 md:p-16 mb-10 relative overflow-hidden shadow-2xl shadow-[#FF5A2A]/20">
           ...
           <div className="relative z-10">
              ...
              <p className="text-white/80 font-medium italic max-w-2xl leading-relaxed">
                Review the rules of engagement for utilizing Athletic Force 1 services. These terms ensure a fair and elite experience for all squads.
              </p>
           </div>
        </div>
        ...
        <div className="space-y-6">
           ...
           <div className="bg-white rounded-[32px] p-10 md:p-16 border border-slate-100 shadow-sm">
              <h2 className="text-2xl font-black italic uppercase tracking-tighter text-slate-900 mb-8 border-b border-slate-100 pb-4">Full Protocol Briefing</h2>
              <div className="prose prose-slate max-w-none italic font-medium text-slate-600 space-y-6">
                 ...
                 <h3 className="text-lg font-black text-slate-900 italic uppercase">Payment Logistics</h3>
                 <p>
                 ...
                 <h3 className="text-lg font-black text-slate-900 italic uppercase">Intellectual Property</h3>
                 <p>
